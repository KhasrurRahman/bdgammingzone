...
@section('title','All Match Result')
@push('css')
...
@section('content')
    ...
    <div class="innner_banner">
        <div class="container">
            <h3>All Match Result</h3>
            <ul class="breadcrumb">
                <li><a href="{{route('home')}}">Home</a></li>
                <li><a href="#">match</a></li>
                <li class="active"><span>All Match Result</span></li>
            </ul>
        </div>
    </div>
    <!--Inner Banner End-->
                ...
                <div class="kf_ticket2_wrap">
                    <ul>
                        @if ($matchs->count() > 0)
                                    ...
                                    <small>{{$lll}}</small>
                                        ...
                                        <div class="kf_opponents_wrap2">
                                            ...
                                            <div class="ticket_button">
                                                <a href="{{route('All_match_result_details',$match->id)}}"><button>View Full Result</button></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--Ticket 2 End-->
                            ...
                            <ul class="breadcrumb">
                                <li class="active" style="text-align: center"><H1>No Match Running Right Now </H1></li>
                            </ul>
                        @endif
