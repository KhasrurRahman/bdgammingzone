    ...
    <div class="innner_banner">
        <div class="container">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><span>Running Match</span></li>
            </ul>
        </div>
    </div>
    <!--Inner Banner End-->
                        ...
                        <div class="col-md-12">
                            ...
                            @if($matchs->count() == 0)
                                <ul class="breadcrumb" style="text-align: center;border: 1px solid;">
                                    <li class="active" ><H1>Next match Running Now</H1></li>
                                </ul>
                            @endif
                                ...
                                <div class="kf_overview kf_current_match_wrap">
                                    ...
                                    <h6 class="kf_hd1 margin_0">
                                        <span>Match ID= #{{$match->id}}</span>
                                            ...
                                            @if($match->stream->first()->link !== null)
                                            <a href="{{route('stream',$match->stream->first()->id)}}" class="kf_cart" style="padding: 0px;float: right;width: 50px">
                                                <i style="border: 0px"><img src="{{asset('public/assets/fontend/images/livenow.gif')}}" alt=""></i>
                                            </a>
                                            @else
                                            <a href="#" class="kf_cart" style="padding: 0px;float: right;width: 50px">
                                                <i style="border: 0px"><img src="{{asset('public/assets/fontend/images/offline.png')}}" alt=""></i>
